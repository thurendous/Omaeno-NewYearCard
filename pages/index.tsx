                    ...
                    <div style={{ padding: '24px 24px 24px 0' }}>
                        ...
                        {isMinted && (
                            <div>
                                ...
                                >
                                    個人的な話になりますが、先日知り合いが原因不明の理由で他界しました。死を前にすると、名誉、お金など何もかもどうでもいい、生きているだけで幸せなんだと、感じた瞬間だった。だからこそ、自分たちが生きているこの人生は前を向き、努力の積み重ねを重視します。常識を破りながら、人や社会が当たり前だと言っていることを常に疑いつつ、激動の時代を生きていこうではないか。
                                </p>
                                <p
                                    style={{
                                        margin: '30px 0 24px',
